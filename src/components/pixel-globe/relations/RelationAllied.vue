  ...
  <g class="relation-group-details">
    ...
    <g class="relation-shield">
      <g class="relation-shield-shape">
        ...
        <path
          class="relation-shield-inner"
          d="M 0 -5.5 L 4.8 -3 L 4.4 2.2 L 0 5.5 L -4.4 2.2 L -4.8 -3 Z"
        />
        <path
          class="relation-shield-star"
          d="M 0 -3 L 0.9 -0.9 L 3 -0.6 L 1.4 0.8 L 1.8 3 L 0 2 L -1.8 3 L -1.4 0.8 L -3 -0.6 L -0.9 -0.9 Z"
        />
      </g>
      <animateMotion
